...
from stompy_live.utils.scene_builders.torso_table_builder import StompyTableSceneBuilder  # noqa


@register_env("StompyPushCube-v2", max_episode_steps=50)
class StompyPushCubeEnv(PushCubeEnv):
    SUPPORTED_ROBOTS = ["stompy_torso"]
