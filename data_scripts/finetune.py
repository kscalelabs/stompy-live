...
class FinetuneConfig:
    ...
    # vla_path: str = "/ephemeral/users/tgao/model_angles/openvla-7b+PushCubeDataset+b16+lr-2e-05cube_step_angles+lora-r32+dropout-0.0" #no brown table                            # Path to OpenVLA model (on HuggingFace Hub)
    # vla_path: str = "/ephemeral/users/tgao/model/openvla-7b+PushCubeDataset+b16+lr-2e-05+lora-r32+dropout-0.0"
