...
class FinetuneConfig:
    ...
    run_root_dir: Path = Path("/ephemeral/users/tgao/model/")                               # Path to directory to store logs & checkpoints
...
# torchrun --standalone --nnodes 8 --nproc-per-node 1 data_scripts/finetune.py --model.type "vla"   --dataset.type "PushCubeDataset"   --run_root_dir "/home/tgao/stompy-live/data_scripts"